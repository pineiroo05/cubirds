...
public class Game {
        ...
        if (!jugador.isHandEmpty()) {
            ...
            if (respuesta.equalsIgnoreCase("s")) {
                ...
                if (numCartas >= bandadaMinima) {
                    ...
                    iu.displayMessage(
                            "Se ha bajado la especie y se ha sumado una bandada de " + aSumar + " a la zona de juego");
                    ...
                    iu.displayMessage("No es posible bajar la especie, solo tienes " + numCartas
                            + " y necesitas al menos " + bandadaMinima);
                }
            }
        }
    ...
    public void finalizarFaltaCartas() {
        ...
        if (ganador != null) {
            iu.displayMessage(
                    "El jugador " + ganador.getName() + " ha ganado la partida por tener más bandadas completas.");
        }
    }
    ...
    public void play() {
        ...
        /*
         * ESTO DE AQUI NO HARIA FALTA YA. El boolean partida acabada ya no haria falta
         * pq sale con el System.exit(0) q hay por turno jugador.
         * 
         ...
         * turnoJugador(jugador);
         * if(jugador.isHandEmpty()){
         * iu.displayMessage("El jugador "+jugador.getName()
